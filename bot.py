...
async def iniciartreino(message):
  ...
  if 'CS GO Fem' in nomes_cargo:
    modalidade = 'CS GO Fem'
  elif 'CS GO' in nomes_cargo:
    modalidade = 'CS GO'
  elif 'Valorant Fem' in nomes_cargo:
    modalidade = 'Valorant Fem'
  elif 'League of Legends Fem' in nomes_cargo:
    modalidade = 'League of Legends Fem'
  elif 'League of Legends' in nomes_cargo:
    modalidade = 'League of Legends'
  elif 'Hearthstone' in nomes_cargo:
    modalidade = 'Hearthstone'
  elif 'FIFA' in nomes_cargo:
    modalidade = 'FIFA'
  elif 'TFT' in nomes_cargo:
    modalidade = 'TFT'
  else:
    embed = discord.Embed(
        title="\n",
        color=0xe6d733,
        description=
        'Você não possui cargo de nenhuma modalidade. Peça para que algum administrador dê o cargo de sua respoectiva modalidade.'
    )
